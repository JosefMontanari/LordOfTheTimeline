...
// // useEffect som körs baserad på svårigetsgrad i useLotrGamesetupMP och hämtar alla kort
...
function LotrMultiplayerGame() {
  ...
  //     currentPlayer.playerCards = playerCards;

  //     nextPlayer = allPlayers[currentPlayer + 1];

  //     setCurrentPLayer(nextPlayer);
  //     setPlayerCards(nextPlayer.playerCards);
  //   }
  ...
  //       name: "Josef",
  //       cardsOnTimeline: [],
  //       numberOfCards: cardsOnTimeline.length,
  //     },
  //     {
  //       name: "Gustav",
  //       cardsOnTimeline: [],
  ...
  return (
    <div className="lotr-game-page">
      <LotrGameBackground />
      <div className="button-card-wrapper"></div>
      <LotrGameTimeline />
